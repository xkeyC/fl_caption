# https://github.com/thewh1teagle/vibe/blob/main/scripts/setup_cuda.ps1
...
if ($CUDA_VERSION_FULL -eq "12.4.0") {
    $downloadUrl = "https://developer.download.nvidia.com/compute/cuda/12.4.0/local_installers/cuda_12.4.0_551.61_windows.exe"
...
# SET CUDA_COMPUTE_CAP fix for building https://github.com/huggingface/candle/issues/1516
Write-Output "CUDA_COMPUTE_CAP=75" >> $env:GITHUB_ENV
