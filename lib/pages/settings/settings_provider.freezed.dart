...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String modelWorkingDir,  String whisperModel,  bool tryWithCuda,  bool withVAD,  double vadThreshold,  String llmProviderUrl,  String llmProviderKey,  String llmProviderModel,  bool llmContextOptimization,  String? audioLanguage,  String? captionLanguage,  int whisperMaxAudioDuration,  int inferenceInterval,  int whisperDefaultMaxDecodeTokens,  double whisperTemperature,  double llmTemperature,  int llmMaxTokens,  String llmPromptPrefix)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettingsData() when $default != null:
return $default(_that.modelWorkingDir,_that.whisperModel,_that.tryWithCuda,_that.withVAD,_that.vadThreshold,_that.llmProviderUrl,_that.llmProviderKey,_that.llmProviderModel,_that.llmContextOptimization,_that.audioLanguage,_that.captionLanguage,_that.whisperMaxAudioDuration,_that.inferenceInterval,_that.whisperDefaultMaxDecodeTokens,_that.whisperTemperature,_that.llmTemperature,_that.llmMaxTokens,_that.llmPromptPrefix);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String modelWorkingDir,  String whisperModel,  bool tryWithCuda,  bool withVAD,  double vadThreshold,  String llmProviderUrl,  String llmProviderKey,  String llmProviderModel,  bool llmContextOptimization,  String? audioLanguage,  String? captionLanguage,  int whisperMaxAudioDuration,  int inferenceInterval,  int whisperDefaultMaxDecodeTokens,  double whisperTemperature,  double llmTemperature,  int llmMaxTokens,  String llmPromptPrefix)  $default,) {final _that = this;
switch (_that) {
case _AppSettingsData():
return $default(_that.modelWorkingDir,_that.whisperModel,_that.tryWithCuda,_that.withVAD,_that.vadThreshold,_that.llmProviderUrl,_that.llmProviderKey,_that.llmProviderModel,_that.llmContextOptimization,_that.audioLanguage,_that.captionLanguage,_that.whisperMaxAudioDuration,_that.inferenceInterval,_that.whisperDefaultMaxDecodeTokens,_that.whisperTemperature,_that.llmTemperature,_that.llmMaxTokens,_that.llmPromptPrefix);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String modelWorkingDir,  String whisperModel,  bool tryWithCuda,  bool withVAD,  double vadThreshold,  String llmProviderUrl,  String llmProviderKey,  String llmProviderModel,  bool llmContextOptimization,  String? audioLanguage,  String? captionLanguage,  int whisperMaxAudioDuration,  int inferenceInterval,  int whisperDefaultMaxDecodeTokens,  double whisperTemperature,  double llmTemperature,  int llmMaxTokens,  String llmPromptPrefix)?  $default,) {final _that = this;
switch (_that) {
case _AppSettingsData() when $default != null:
return $default(_that.modelWorkingDir,_that.whisperModel,_that.tryWithCuda,_that.withVAD,_that.vadThreshold,_that.llmProviderUrl,_that.llmProviderKey,_that.llmProviderModel,_that.llmContextOptimization,_that.audioLanguage,_that.captionLanguage,_that.whisperMaxAudioDuration,_that.inferenceInterval,_that.whisperDefaultMaxDecodeTokens,_that.whisperTemperature,_that.llmTemperature,_that.llmMaxTokens,_that.llmPromptPrefix);case _:
  return null;
